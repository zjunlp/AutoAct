...
def call_bing_search(query, count, endpoint="https://api.bing.microsoft.com/v7.0/search", bing_api_key="7be8d4c7404148cdaa454d4487fc219e"):
    ...
    try:
        ...
        if resp_status == 200:
            ...
            return parse_bing_result(result)
    except:
        pass
