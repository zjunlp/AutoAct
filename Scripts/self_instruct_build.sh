python /data/rolnan/AutoAct/Self_Plan/Self_Instruct/data_generation.py\
    --source_data  /data/rolnan/AutoAct/Self_Instruct/Meta_sample/Meta_Hotpotqa.json  \
    --target_data  /data/rolnan/AutoAct/Self_Instruct/hotpotqa_metaqa.json \
